...
const pilares = [
  ...
  },
  {
    icon: Heart,
    title: "Salud",
    description: "Promovemos ambientes de trabajo saludables y servicios que contribuyen al bienestar general.",
    items: [
  ...
  },
  {
    ...
    items: ["Certificaciones internacionales", "Mejora continua", "Gestión de riesgos", "Seguimiento de indicadores"],
  },
];
    ...
    >
      ...
      <section className="py-20 bg-gradient-to-b from-[#31606E] to-[#003F4F] text-white">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">Compromiso con la Sostenibilidad</h1>
            <p className="text-xl text-gray-100 max-w-3xl mx-auto leading-relaxed font-poppins">
              En MVA, la sostenibilidad es un pilar fundamental que guía todas nuestras operaciones, asegurando un
              impacto positivo en el medio ambiente, la seguridad y la salud.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <div>
              <h2 className="text-3xl font-bold text-[#003F4F] mb-4 font-montserrat">Nuestro Enfoque Sustentable</h2>
              <p className="text-gray-700 mb-4 font-poppins">
                En MVA entendemos que la sostenibilidad no es solo una responsabilidad empresarial, sino también una
                oportunidad para innovar y ofrecer mejores servicios.
              </p>
              <p className="text-gray-700 mb-4 font-poppins">
                Nuestro compromiso se refleja en cada aspecto de nuestra operación, desde la selección de materiales y
                tecnologías hasta las prácticas de gestión y el relacionamiento con las comunidades.
              </p>
              <p className="text-gray-700 font-poppins">
                Trabajamos continuamente para reducir nuestra huella ambiental mientras mejoramos la calidad y
                  ...
                  <Card className="h-full shadow-lg border-l-4 border-[#00A6B2]">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-2xl font-semibold text-[#003F4F] font-montserrat">{pilar.title}</h3>
                      </div>

                      <p className="text-gray-700 mb-4 font-poppins">{pilar.description}</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <h2 className="text-3xl font-bold text-[#003F4F] font-montserrat">Nuestras Certificaciones</h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto mt-4 font-poppins">
              Cumplimos con los más altos estándares internacionales en gestión ambiental, seguridad y calidad.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
            {[1, 2, 3, 4].map((item) => (
              ...
              >
                <div className="text-center text-gray-500 font-semibold">Certificación {item}</div>
              </motion.div>
            ))}
          </div>
        </div>
