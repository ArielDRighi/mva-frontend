...
export default function NotFoundPage() {
  return (
    <motion.div
      className="relative flex-1 flex flex-col items-center justify-center bg-white p-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-mva-turquesa mb-6 font-montserrat">
